/**
  *	I2C1_Settings_for_OVERWATCH(void)
...
void I2C1_Settings_for_OVERWATCH(void){
	 ...
	 * pairs of pins:
	 * 1. SCL on PB8 and SDA on PB9 
	 */
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_8 | GPIO_Pin_9; // we are going to use PB8 and PB9
	GPIO_InitStruct.GPIO_Mode = GPIO_Mode_AF;			// set pins to alternate function
	GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;		// set GPIO speed
	GPIO_InitStruct.GPIO_OType = GPIO_OType_OD;			// set output to Push-Pull //the line has to be only pulled low, not driven high <- Open-Drain.
	...
	// configure I2C1 
	I2C_InitStruct.I2C_ClockSpeed = 100000; 		// 200kHz
